...
function DialogCanUnlock(C, Item) {
	...
	if (C.IsLoverOfPlayer() && InventoryAvailable(Player, "LoversPadlockKey", "ItemMisc") && Item.Asset.Enable && (!Item.Property.LockedBy.startsWith("Owner") || !(LogQuery("BlockKeyLovers", "OwnerRule")))) return true;
